...
namespace FSCruiserV2.Forms
{
    public partial class LayoutTreeBased : UserControl, ITallyView
    {
        ...
        public LayoutTreeBased(IApplicationController controller, FormDataEntryLogic dataEntryController)
            : this()
        {
        ...
        public Control MakeTallyRow(Control container, FSCruiserV2.Logic.SubPop subPop)
        {
            throw new NotImplementedException();
        }
